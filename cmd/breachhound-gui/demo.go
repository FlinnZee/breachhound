...
func demoResult() scanResult {
	...
	findings := []core.Finding{
		...
		{ID: "demo-11", Title: "Windows Security Audit Log Cleared", Description: "The Windows Security event log was cleared, a common anti-forensic step.", Severity: core.SevHigh, Confidence: core.ConfMedium, Technique: "T1070.001", Tactic: "Defense Evasion", Source: "sigma", Evidence: []string{"Security event 1102", "The audit log was cleared."}},
		{ID: "demo-12", Title: "Suspicious PowerShell Download Cradle", Description: "PowerShell script block fetching and executing remote content.", Severity: core.SevHigh, Confidence: core.ConfMedium, Technique: "T1059.001", Tactic: "Execution", Source: "sigma", Evidence: []string{"Microsoft-Windows-PowerShell/Operational event 4104"}},
		{ID: "demo-13", Title: "Member Added to Administrators Group", Description: "A member was added to the local Administrators group.", Severity: core.SevMedium, Confidence: core.ConfMedium, Technique: "T1098", Tactic: "Persistence", Source: "sigma", Evidence: []string{"Security event 4732"}},
	}
